(function (n, t) {
    ...
    var r = $("section#loading"), f = r.find(".progress .progress-bar"), n, t, i, u;
    for (r.css({display: "block"}), n = ["banner13.jpg", "banner07.jpg", "banner05.jpg", "banner10.jpg", "banner02.jpg", "banner03.jpg", "banner11.jpg", "banner09.jpg", "banner04.jpg", "banner01.jpg"], t = 0, i = 0; i < n.length; i++)u = new Image, u.src = "/images/banners/" + n[i], u.onload = function () {
        t++;
        f.css("width", t / n.length * 100 + "%");
        t == n.length && r.addClass("isCompleted")
    }
}()